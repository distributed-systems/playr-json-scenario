        ...
        , applyTo: function(response) {
            ...
            if (definition) {
                ...
                return Promise.resolve().then(() => {
                    ...
                    // content
                    if (definition.content) return this.validateContent('HTTP Response Data', response.data, definition.content, messages);
                    else return Promise.resolve();
                }).then((result) => {
                    this.addMessages(messages, result);
            ...
            if (type.array(validators)) {
                ...
                return this.validate(name, data, validators).then((result) => {
                    ...
                    if (type.object(validators)) {
                        log.warn('validator', validators.kind);
